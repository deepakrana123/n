...
export const idProofs = [
  {
    ...
    columns: [
      ...
      },
      {
        ...
        maxlength: 20,
        maxLengthMessage: "Income cannot be more than 20 characters",
        minlength: 1,
        required: true,
        minLengthMessage: "Income must be at least 1 character",
        validation: "^[0-9]+(\\.[0-9]{1,2})?$",
        validationMessage: "Invalid Income format",
        color: "",
        disabled: false,
        readonly: false,
        value: "",
        dependableField: [
          ...
          },
          {
            ...
            maxlength: 20,
            maxLengthMessage: "Yearly Salary cannot be more than 20 characters",
            minlength: 1,
            required: true,
            minLengthMessage: "Yearly Salary must be at least 1 character",
            color: "",
            disabled: false,
            readonly: false,
            value: "",
            validation: "^[0-9]+(\\.[0-9]{1,2})?$",
            validationMessage: "Invalid Yearly Salary format",
          },
        ],
      },
      {
        ...
        dependableField: [
          ...
          },
          {
            ...
            maxlength: 50,
            maxLengthMessage: "Branch Name cannot be more than 50 characters",
            minlength: 3,
            required: true,
